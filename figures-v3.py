...
def execute_select(): 
    ...
    # plot_amo_timeseries( amo, outputfile="amo_timeseries.pdf" )
    # compare_explained_variance( outputfile="explained_variance.tex", analyses=[ccmp_analyses_linear,ccmp_analyses], labels=["linear only","with AMO"], latex=True )
    # plot_table_of_trends( ccmp_analyses, cmip6_analyses, outputfile="table_of_trends.pdf" ) 
    # plot_table_of_amo( ccmp_analyses, cmip6_analyses, outputfile="table_of_amo.pdf" ) 
    # amo_trend_covariance( ccmp_analyses, cmip6_analyses, amo, season="All", outputfile="amo_trend_covariance.pdf" ) 
