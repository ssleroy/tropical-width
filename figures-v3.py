...
def regress( times, vals, pdo=None, amo=None, rindices=False, noautocorrelation=False ):
...
def expand( times, coeffs, covariance, labels, timereference, amo=None, pdo=None, rindices=False ):
...
def compute_ccmp_linear_regressions( outputfile="ccmp_trends.dat", jsonsavefile='ccmp_analyses.json', 
                                    pdo=None, amo=None, rindices=False ): 
    ...
    for imethod, method in enumerate( methods ):
        for iregion, region in enumerate( regions ):
            ...
            for season in seasons:
                ...
                ret = regress( x, y, pdo=pdo, amo=amo, rindices=rindices, noautocorrelation=(season != "All") )
...
def compute_era5_linear_regression( outputfile='era5_trends.dat', pdo=None, amo=None, rindices=False ): 
...
def compute_cmip6_linear_regression( outputfile='cmip6_trends.dat', jsonsavefile="cmip6_analyses.json", 
                                    pdo=None, amo=None, rindices=False ): 
...
def compute_total_width_trend( ccmp_analyses, pdo=None, amo=None, rindices=False ): 
    ...
    ret = regress( x, y, pdo=pdo, amo=amo, rindices=rindices )
...
def plot_ccmp_era5_timeseries_deseasonalized( ccmp_analyses, era5_analyses, outputfile="ccmp_era5_deseasonalize_timeseries.pdf", pdo=None ): 
    ...
    for ihemisphere, hemisphere in enumerate( [ "N", "S" ] ): 
        ...
        ret = expand( ccmp_rec['times'], ccmp_rec['coefficients'], ccmp_rec['uncertainty_covariance'], 
                     ccmp_rec['labels'], ccmp_rec['time_reference'], pdo=pdo, rindices=rindices )
...
def execute_all(): 
    ...
    ccmp_analyses = compute_ccmp_linear_regressions( outputfile=os.path.join(outputdir,"ccmp_trends.dat"), jsonsavefile=os.path.join(outputdir,"ccmp_analyses.json"), pdo=pdo, amo=amo, rindices=rindices ) 
    era5_analyses = compute_era5_linear_regression( outputfile=os.path.join(outputdir,"era5_trends.dat"), pdo=pdo, amo=amo, rindices=rindices ) 
    cmip6_analyses = compute_cmip6_linear_regression( outputfile=os.path.join(outputdir,"cmip6_trends.dat"), jsonsavefile=os.path.join(outputdir,"cmip6_analyses.json"), pdo=pdo, amo=amo, rindices=rindices ) 
    ...
    trend, uncertainty = compute_total_width_trend( ccmp_analyses, pdo=pdo, amo=amo, rindices=rindices ) 
    ...
    plot_ccmp_era5_timeseries_deseasonalized( ccmp_analyses, era5_analyses, pdo=pdo, amo=amo, outputfile=os.path.join(outputdir,"ccmp_era5_deseasonalize_timeseries.pdf") ) 
...
def execute_select(): 
    ...
    ccmp_analyses_linear = compute_ccmp_linear_regressions( outputfile=os.path.join(outputdir,"tmp.dat"), jsonsavefile=os.path.join(outputdir,"ccmp_analyses.json") ) 
    ccmp_analyses = compute_ccmp_linear_regressions( outputfile=os.path.join(outputdir,"ccmp_trends.dat"), jsonsavefile=os.path.join(outputdir,"ccmp_analyses.json"), pdo=pdo, amo=amo ) 
    cmip6_analyses = compute_cmip6_linear_regression( outputfile=os.path.join(outputdir,"cmip6_trends.dat"), jsonsavefile=os.path.join(outputdir,"cmip6_analyses.json"), pdo=pdo, amo=amo ) 

    plot_amo_timeseries( amo, outputfile=os.path.join(outputdir,"amo_timeseries.pdf") )
    compare_explained_variance( outputfile=os.path.join(outputdir,"explained_variance.dat"), analyses=[ccmp_analyses_linear,ccmp_analyses], labels=["linear only","with AMO"], latex=False )
    compare_explained_variance( outputfile=os.path.join(outputdir,"explained_variance.tex"), analyses=[ccmp_analyses_linear,ccmp_analyses], labels=["linear only","with AMO"], latex=True )
    plot_table_of_trends( ccmp_analyses, cmip6_analyses, outputfile=os.path.join(outputdir,"table_of_trends.pdf") ) 
